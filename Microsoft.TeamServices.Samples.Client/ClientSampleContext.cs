...
namespace Microsoft.TeamServices.Samples.Client
{
    ...
    public class ClientSampleContext
    {
        ...
        public static ClientSampleContext CurrentContext
        {
            get
            {
                if (currentContext == null)
                {
                    ...
                    currentContext = new ClientSampleContext(new Uri("https://casaau.visualstudio.com"), vssCred);
                    currentContext.Connection.ConnectAsync().SyncResult();
                }
        ...
        private static ClientSampleContext currentContext;
